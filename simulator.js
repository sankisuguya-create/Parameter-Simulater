 ...
 decide(a){
  ...
  if(a.team==='oni'){
   ...
   if(a.role==='guard'){
    ...
    if(n.agent){const v=norm(n.agent.x-a.x,n.agent.y-a.y);a.vx=v.x;a.vy=v.y;a.action='牢屋を守る';a.wantsSprint=true;return}
   ...
   if(a.target){const v=norm(a.target.x-a.x,a.target.y-a.y);a.vx=v.x;a.vy=v.y;a.action=a.role==='guard'?'見張る':'追いかける';a.wantsSprint=a.role==='chaser'}else{a.vx=a.vy=0}
   return;
  }
